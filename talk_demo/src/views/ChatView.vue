...
<template>
  <div class="chat-page-wrapper d-flex justify-content-center align-items-center position-relative">
    ...
    <div class="main-card-container d-flex flex-column position-relative">
      ...
      <div class="flex-grow-1 overflow-hidden d-flex flex-column position-relative">
        ...
        >
          <div class="card p-4 shadow-sm text-center border-0 w-100 match-card">
            <div class="mb-3">
              <button
                type="button"
                class="btn btn-custom-cyan btn-lg w-100 fw-bold"
              >
                請先選擇想要配對的對象
              </button>
            </div>
            ...
            <div class="mb-4">
              <div class="gender-selector d-flex justify-content-center gap-4 w-100">
                <button
                  type="button"
                  :class="[
        ...
        >
          ...
          >
            ...
            >
              <span
                v-if="item.senderSocketId !== mySocketId"
                class="sender-name"
              >
                {{ item.senderName }}
              </span>
      ...
      <!-- 輸入框與 Modal 部分保持不變 -->
      <form
        class="custom-input-group p-2 d-flex align-items-center gap-2"
        @submit.prevent="sendMessage"
      >
        <button
          type="button"
          class="btn btn-danger rounded-pill px-3 fw-bold flex-shrink-0"
        ...
        <button
          type="submit"
          class="btn btn-primary rounded-pill px-3 fw-bold flex-shrink-0"
          :disabled="!inRoom"
        >
          傳送
        </button>
    ...
    <div
      v-if="isModalOpen"
      class="modal d-block bg-dark bg-opacity-75 d-flex align-items-center justify-content-center"
      style="z-index: 1055;"
    >
      <div
      ...
      >
        <div
          class="modal-content text-white border-0 shadow-lg"
          style="background-color: #2b2b2b; border-radius: 12px; padding: 10px;"
        >
